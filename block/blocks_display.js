...
module.exports = function (Blockly) {
  ...
  // ######################################################################
  Blockly.Blocks["tft_display_setBrightness"] = {
    init: function () {
      this.appendValueInput("bright")
        .setCheck("Number")
        .appendField("display setBrightness (0-255)");
      this.setInputsInline(true);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(230);
  ...
  Blockly.Blocks["tft_display_draw_triangle"] = {
    init: function () {
      this.appendValueInput("x0")
        // .appendField(new Blockly.FieldImage("https://www.flaticon.com/premium-icon/icons/svg/1163/1163412.svg", 20, 20, "*"))
        .setCheck("Number")
        .appendField("draw Triangle at (X0");
      this.appendValueInput("y0")
        .setCheck("Number")
        .appendField(", Y0");
      this.appendValueInput("x1")
  ...
  Blockly.Blocks["display_draw_progress_bar"] = {
    init: function () {
      this.appendValueInput("x")
        // .appendField(new Blockly.FieldImage("https://www.flaticon.com/premium-icon/icons/svg/1163/1163412.svg", 20, 20, "*"))
        .setCheck("Number")
  ...
  Blockly.Blocks["display_draw_pixel"] = {
    init: function () {
      this.appendValueInput("x")
        // .appendField(new Blockly.FieldImage("https://www.flaticon.com/premium-icon/icons/svg/1163/1163412.svg", 20, 20, "*"))
        .setCheck("Number")
  ...
  Blockly.Blocks['display_qrcode'] = {
    init: function () {
      this.appendDummyInput()
        .appendField("QRcode Generator link:");
      this.appendValueInput("NAME")
        .setCheck("String");
      this.appendDummyInput()
        .appendField("X")
        .appendField(new Blockly.FieldNumber(50, 0, 320), "x")
        .appendField(", Y")
        .appendField(new Blockly.FieldNumber(10, 0, 240), "y")
        .appendField(", width")
        .appendField(new Blockly.FieldNumber(220), "width")
        .appendField(", version")
        .appendField(new Blockly.FieldNumber(6, 0, 255), "version");
      this.setInputsInline(true);
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(230);
